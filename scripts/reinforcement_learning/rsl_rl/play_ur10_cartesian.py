...
"""Convenience launcher for trained UR10 Cartesian IK reach policies."""
...
DEFAULT_TASK = "Isaac-Reach-UR10-Cartesian-Play-v0"
DEFAULT_EXPERIMENT = "reach_ur10_cartesian"
DEFAULT_RUN = "2026-07-11_00-54-23"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run a trained UR10 Cartesian IK reach RSL-RL policy in Isaac Lab.",
